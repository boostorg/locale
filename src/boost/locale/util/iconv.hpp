...
namespace boost { namespace locale {
    ...
    typedef size_t (*const_iconv_ptr_type)(iconv_t d,
                                           ...
                                           size_t*);
    typedef size_t (
      *nonconst_iconv_ptr_type)(iconv_t d, char** in, size_t* insize, char** out, size_t* outsize, uint32_t, size_t*);
    }
    ...
    inline size_t
    do_iconv(nonconst_iconv_ptr_type ptr, iconv_t d, char** in, size_t* insize, char** out, size_t* outsize)
    {
